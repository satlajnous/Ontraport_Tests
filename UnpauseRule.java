...
public class UnpauseRule extends OntraportFirefoxTest {

	AppUtilities appUtilities = new AppUtilities();
	
	@Test
	public void testUnpauseRule() throws Exception {
...
/*		
		...
		Thread.sleep(3000);
		driver.findElement(By.linkText("Unpause Rule")).click();
		Thread.sleep(3000);
		...
		Assert.assertTrue(txt.contains("Run"));
