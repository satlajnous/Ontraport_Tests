...
public class CreateProduct extends OntraportFirefoxTest {
	...
	public void testCreateContact() throws Exception {
		...
		nameTxtBox.clear();
		nameTxtBox.sendKeys("Name"+varTimeStamp);
		
		WebElement priceTxtBox = getTextBoxOnTheLabel(driver, "Price");
		priceTxtBox.clear();
		priceTxtBox.sendKeys("180.00");
